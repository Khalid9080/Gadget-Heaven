...
const Dashboard = () => {
    return (
        <div>
                ...
                <div className="bg-[#9538E2] py-10 space-y-5 text-center items-center flex flex-col -mt-0 ">
                    ...
                    <div className="space-x-5">
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                isActive
                                    ? "btn text-[#9538E2] bg-white px-10 rounded-3xl py-1 text-lg"
                                    : "btn text-white border-white bg-[#9538E2] px-10 rounded-3xl text-lg" 
                            }
                        >
                            Cart
                        </NavLink>
            ...
            {/* Outlet here will render either Cart or Wishlist based on the selected route */}
            <Outlet />
